...
class Laser(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("C:/Users/Aless/OneDrive/Escritorio/laser.png").convert()
...
class Meteor(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('C:/Users/Aless/OneDrive/Escritorio/inv2.png').convert()
        self.image.set_colorkey(negro)
        self.rect = self.image.get_rect()
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load('C:/Users/Aless/OneDrive/Escritorio/nave2.png').convert()
        self.image.set_colorkey(negro)
        self.rect = self.image.get_rect()
